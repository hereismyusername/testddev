...
RSpec.describe CommentsController, type: :controller do
  describe "comments#create action" do
    it "should allow users to create comments on grams" do
      ...
      post :create, params: { gram_id: gram.id, comment: { message: 'comment' } }
    ...
    it "should require a user to be logged in to comment on a gram" do
      gram = FactoryGirl.create(:gram)
      post :create, params: { gram_id: gram.id, comment: { message: 'comment 3' } }
    ...
    it "should return http status code of not found if the gram isn't found" do
      user = FactoryGirl.create(:user)
      sign_in user
      post :create, params: { gram_id: 'ID3', comment: { message: 'comment 4' } }
